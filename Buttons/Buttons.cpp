...
This library was written by Mr.Noop. 
...
/*
	...
	length => The size of buttons that you will use.
*/
...
/*
	This method will add the button you have defined to the pool
	This method will not add the button if you try to add it twice or 
	if you try to add more then you have defined the size of buttons.
	_button => The address of the button you wish to add to the pool.
	Returns true if succesfull
*/
bool Buttons::add(Button* _button){
